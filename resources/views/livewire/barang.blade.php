...
<div class="[:where(&)]:max-w-8xl px-6 lg:px-10 m-auto">
    <div>
        <div class="grid auto-rows-min gap-4 md:grid-cols-3 mb-6">
            <div class="group relative overflow-hidden rounded-xl border border-white/10 bg-gradient-to-tr from-blue-600 to-blue-700 shadow-sm col-span-2">
                <div class="absolute mix-blend-overlay opacity-90 inset-0 z-0 bg-[size:20px_20px] bg-[image:linear-gradient(to_right,#e7e5e4_1px,transparent_1px),linear-gradient(to_bottom,#e7e5e4_1px,transparent_1px)]" style="
            mask-image:
        ...
        "></div>
            ...
            <div class="group relative overflow-hidden rounded-xl border border-white/10 bg-gradient-to-tr from-blue-600 to-blue-700 shadow-sm">
                ...
                <div class="relative z-10 flex h-full flex-col justify-between p-6 text-white">
                    <div>
                        <div class="mb-2 flex items-center justify-between">
                            <p class="text-sm font-medium text-blue-100/80">Projects</p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-white/70 shadow-sm">
                        ...
                        <h3 class="text-3xl font-bold tracking-tight text-white">{{ count($this->projects) }} Projects</h3>
                    </div>

                    <div class="mt-4 flex w-fit items-center rounded-md border border-white/10 bg-white/10 px-2 py-1 text-xs font-medium text-white backdrop-blur-md">
                        Total projecst dimiliki
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Select Paket -->
    <div class="relative mb-6 w-full border-zinc-100 p-6 rounded-lg bg-white shadow-sm border-1 hover:shadow-md transition">
    ...
    <div class="relative mb-6 w-full border-zinc-100 p-6 rounded-lg bg-white border-1 shadow-sm mx-auto hidden">
    ...
    <div wire:loading.remove wire:target="getSpectech" class="relative mb-6 w-full border-1 border-zinc-100 p-6 rounded-lg bg-white shadow-sm hover:shadow-2xl transition">
        <div>
            <flux:heading size="xl" level="1">{{ $this->projectSelected['name'] }}
                ({{ $this->projectSelected['code'] }})</flux:heading>
           <flux:subheading size="md">{{ Str::ucwords(strtolower($this->projectSelected['company_name'])) }}</flux:subheading>
    ...
    @if ($this->projectSelected)
    <div class="relative mb-6 w-full border-1 border-zinc-100 p-6 rounded-lg bg-white shadow-sm" wire:loading.remove wire:target="getSpectech">
            ...
            <table class="w-full text-xs shadow-lg">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-neutral-200 bg-neutral-50">
                        ...
                        <td class="text-right flex justify-end px-3 py-3">
